...
class Mars(object):
    ...
    track_val_info_path =osp.join(root,"info_v2/val_info.npy")
    ...
    def __init__(self, min_seq_len=0):
        ...
        print("  val    | {:5d} | {:8d}".format(num_train_pids, num_train_tracklets))
    ...
    def _check_before_run(self):
        ...
        f not osp.exists(self.track_train_info_path):
